...
from .views import (
    ...
    UserPayOfferView, AdminRequestDetailView,
...
urlpatterns = [
    ...
    path('users/pay-offer/', UserPayOfferView.as_view(), name='user-pay-offer'),
    path("admin/<int:pk>/", AdminRequestDetailView.as_view(), name="admin-request-detail"),
